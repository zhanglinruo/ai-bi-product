...
const FIELD_TABLE_MAPPING: Record<string, string> = {
  'amount': 't_ai_medical_product_records',
  'quantity': 't_ai_medical_product_records',
  'price': 't_ai_medical_product_records',
  'id': 't_ai_medical_product_records',
  'hospital_code': 't_ai_medical_product_records',
  'hospital_name': 't_ai_medical_product_records',
  'province': 't_ai_medical_product_records',
  'city': 't_ai_medical_product_records',
  'county': 't_ai_medical_product_records',
  'product_name': 't_ai_medical_product_records',
  'generic_name': 't_ai_medical_product_records',
  'brand_name': 't_ai_medical_product_records',
  'manufacturer': 't_ai_medical_product_records',
  'corporate_group': 't_ai_medical_product_records',
  'category': 't_ai_medical_product_records',
  'record_date': 't_ai_medical_product_records',
  'dosage_form': 't_ai_medical_product_records',
  'specifications': 't_ai_medical_product_records',
  'hospital_level': 't_ai_medical_product_records',
  'total_amount': 't_ai_medical_product_records',
  'order_id': 't_ai_medical_product_records',
};
